  ...
  return (
    <div className="space-y-8 max-w-2xl mx-auto">
      <div className="flex items-center gap-4 mb-2">
        ...
        <h1 className="text-3xl font-serif text-[var(--color-luxury-black)]">Add New Category</h1>
      </div>
        ...
        <div className="bg-white p-6 md:p-8 border border-gray-200 shadow-sm rounded-lg space-y-6">
          <div className="space-y-4">
            <div>
              ...
              <input name="name_en" type="text" required className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-[var(--color-luxury-black)] focus:border-[var(--color-luxury-black)] outline-none" placeholder="e.g. Makeup" />
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Category Name (Arabic) *</label>
              <input name="name_ar" type="text" required className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-[var(--color-luxury-black)] focus:border-[var(--color-luxury-black)] outline-none text-right font-arabic" placeholder="مثلاً: المكياج" />
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Slug (URL Key) *</label>
              <input name="slug" type="text" required className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-[var(--color-luxury-black)] focus:border-[var(--color-luxury-black)] outline-none font-mono text-sm" placeholder="e.g. makeup" />
              <p className="text-[10px] text-gray-400 mt-1">This is how the category appears in the URL (e.g. /category/makeup)</p>
            </div>
          </div>
        </div>
